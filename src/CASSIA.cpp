    ...
    for (int day = 0; day < days_per_year; day++) {
      ...
      if (day == 0) {
        ...
        if (final_year%2!=0) {
          ...
          xylem_sh_mass = culm_growth_internal.xylem_st[weather_index-1];
          ...
          xylem_sh_mass = culm_growth.xylem_st[weather_index-1];
      ...
      if (final_year%2!=0) {
        ...
        if (day == 0) {
          if (year == start_year) {
            ...
            culm_growth_internal.xylem_sh.push_back(M_PI * pow(xylem_width/1000, 2) * (height_next_year + actual_growth_out.height) * parameters.cell_wall_density_ew);
        ...
        if (day == 0) {
          if (year == start_year) {
            ...
            culm_growth.xylem_sh.push_back(M_PI * pow(xylem_width/1000, 2) * (height_next_year + actual_growth_out.height) * parameters.cell_wall_density_ew);
