...
| Model | Variable | Units Transformed |
|-------|----------|------------------|
| PRELES | PAR | sum µmol per day |
| PRELES, CASSIA | Temperature | °C |
| PRELES, CASSIA | Precipitation | mm |
| PRELES | VPD | kPa |
| PRELES | Relative Humidity | % |
| CASSIA | Soil Temperature | °C |
| CASSIA | Soil water content | mol m-3 |
| phydro | Surface solar radiation downwards | umol m-2 s-1 |
| phydro | VPD | hPa |
| phydro | PPFD | umol m-2 s-1 |
| phydro | PPFD Max | umol m-2 s-1 |
| phydro | Soil Water Potential | - MPa |
| phydro | GPP | µmol m⁻² s⁻¹ |
