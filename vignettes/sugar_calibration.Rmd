...
parameters_2015$sperling_test[c("Wala.needles"), c("Hyde")] <- 1
...
objective_function <- function(par) {
  ...
  for (name in names(par)) {
    parameters_2015$sperling_test[name, "Hyde"] <- par[name]
  }
...
# Sugar, Starch
par(mfrow = c(1, 2))
plot(dates, CASSIA_preles_1998_2022_sugar_low$Sugar$sugar, type = "l", col = "red", ylab = "Sugar", xlab = "Dates", ylim = c(0, max(CASSIA_preles_1998_2022_sugar_high$Sugar$sugar, CASSIA_preles_1998_2022$Sugar$sugar, na.rm = T)))
...
plot(dates, CASSIA_preles_1998_2022_sugar_low$Sugar$starch, type = "l", col = "red", ylab = "Starch", xlab = "Dates", ylim = c(0, max(CASSIA_preles_1998_2022$Sugar$starch, CASSIA_preles_1998_2022_sugar_low$Sugar$starch, na.rm = T)))
...
# Storage term
par(mfrow = c(1, 1))
plot(dates, CASSIA_preles_1998_2022_sugar_low$Sugar$storage_term, type = "l", col = "red", ylab = "Storage term", xlab = "Dates", ylim = c(0, 1))
lines(dates, CASSIA_preles_1998_2022_sugar_medium$Sugar$storage_term, col = "gold")
lines(dates, CASSIA_preles_1998_2022$Sugar$storage_term, col = "green")
...
# Seasonal, growth
par(mfrow = c(1, 2))
plot(dates, CASSIA_preles_1998_2022_sugar_low$Growth$height_growth, type = "l", col = "red", ylab = "Height", xlab = "Dates", ylim = c(0, max(CASSIA_preles_1998_2022_sugar_high$Growth$height_growth, CASSIA_preles_1998_2022$Growth$height_growth, na.rm = TRUE)))
...
plot(dates, CASSIA_preles_1998_2022_sugar_low$Growth$diameter_growth, type = "l", col = "red", ylab = "Diameter", xlab = "Dates", ylim = c(0, max(CASSIA_preles_1998_2022_sugar_high$Growth$diameter_growth, CASSIA_preles_1998_2022$Growth$diameter_growth, na.rm = TRUE)))
...
# Culmative
plot(dates, CASSIA_preles_1998_2022_sugar_low$Culm_Growth$culm_growth_height, type = "l", col = "red", ylab = "Height", xlab = "Dates")
...
plot(dates, 0.1 * CASSIA_preles_1998_2022_sugar_low$Culm_Growth$culm_growth_diameter, type = "l", col = "red", ylab = "Diameter", xlab = "Dates")
...
plot(dates, CASSIA_preles_1998_2022$Culm_Growth$culm_growth_roots)
