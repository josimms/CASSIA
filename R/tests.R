...
test_against_original_data <- function(new_parameters, calibration, sperling_sugar_model, using_spp_photosynthesis) {
  ...
  CASSIA_new_output = CASSIA_yearly(2015, 2017, weather_original, GPP_ref,
  ...
  plot(dates, CASSIA_new_output$Sugar$sugar_needles +
         ...
         CASSIA_new_output$Sugar$sugar_xylem_st, main = "Sugar", col = "blue", type = "l", xlab = "Days of the Year", ylab = "Sugar, kg C")
  ...
  plot(dates, CASSIA_new_output$Sugar$starch_needles +
         ...
         CASSIA_new_output$Sugar$starch_xylem_st, main = "Starch", col = "blue", type = "l", xlab = "Days of the Year", ylab = "Starch, kg C")
  abline(h = 0, lty = 2, col = "grey")
