---
title: "Sugar Calibration"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Sugar Calibration}
...
parameters_2015$sperling_test[names(fit$optim$bestmem), "Hyde"] <- c(
  ...
  0.9, 0.0, 0.9,   # phloem
  0.9, 0.0, 0.9,   # roots
  0.9, 0.0, 0.9,   # xylem.sh
  0.9, 0.0, 0.9,   # xylem.st
  0.09, 0.11, 0.2, 0.01, 0.1,
  0.15 # myco.thresh in all sugar
)
...
lines(dates_2015, CASSIA_preles_2015$Sugar$sugar_needles, col = "green")
lines(dates_2015, CASSIA_preles_2015$Sugar$sugar_roots, type = "l", col = "black")
...
lines(dates_2015, CASSIA_preles_2015$Sugar$starch_xylem_sh, type = "l", col = "red")
lines(dates_2015, CASSIA_preles_2015$Sugar$starch_needles, col = "green")
lines(dates_2015, CASSIA_preles_2015$Sugar$starch_roots, type = "l", col = "black")
...
# Multiple years
needle_mass = c("pine_foliage_biomass", "pine_foliage_biomass_ICOS")
needle_mass_data = loaded_data$smearII_data[loaded_data$smearII_data$variable %in% needle_mass,]
...
points(as.Date(paste0(needle_mass_data$date, "-01-01")), needle_mass_data$amount/1010, col = "blue", pch = "x")
...
ylim = range(0, CASSIA_preles_1998_2022$Sugar$starch_needles,
             CASSIA_preles_1998_2022$Sugar$starch_phloem,
             CASSIA_preles_1998_2022$Sugar$starch_xylem_sh,
             CASSIA_preles_1998_2022$Sugar$starch_xylem_st, 
             CASSIA_preles_1998_2022$Sugar$starch_roots, na.rm = T)
if (is.infinite(ylim[2])) {
  ylim[2] = 1
}
