...
ylim = range(c(0, 
               ...
               cumsum(CASSIA_preles_1998_2022_nitrogen_investment$Sugar$sugar_mycorrhiza)), na.rm = T)
...
lines(dates, CASSIA_preles_1998_2022_nitrogen_investment$Sugar$nitrogen_capacity, col = "pink")

plot(dates, CASSIA_preles_1998_2022_nitrogen_medium$Sugar$storage/5, type = "l", xlab = "Years", ylab = "Nitorgen Capacity (between 0 and 1)", col = "orange", ylim = c(0, 0.6))
lines(dates, CASSIA_preles_1998_2022_nitrogen_low$Sugar$storage/5, col = "red")
