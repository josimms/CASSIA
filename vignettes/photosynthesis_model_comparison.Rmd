...
weather_preles_1997_2022$fAPAR <- 0.9 # TODO: take away when I have found the problem
...
parameters_1997_2022$sperling_test[c("sugar00"),c("Hyde")] <- 0.2
...
CASSIA_preles_1997_2022 <- CASSIA_cpp(weather = weather_preles_1997_2022,
                                      site = "Hyde",
                                      pPREL = c(parameters_1997_2022$pPREL, parameters_1997_2022$N_parameters),
                                      parameters = parameters_1997_2022$parameters_test,
                                      common = common_p,
                                      ratios = ratios_p,
                                      sperling = parameters_1997_2022$sperling_test,
                                      needle_mass_in = parameters_1997_2022$needle_mass_in,
                                      Throughfall = parameters_1997_2022$Throughfall,
                                      photosynthesis_as_input = FALSE,
                                      preles = TRUE,
                                      fAPAR_Tian = FALSE)
# GPP
...
# Sugar
plot_sugar_starch_comparison(CASSIA_preles_1997_2022, date_1997_2022, loaded_data$original_data, loaded_data$yu_data)
...
plot(date_1997_2022, CASSIA_preles_1997_2022$Culm_Growth$culm_growth_needles, col = "black", pch = "x", main = "Foliage Biomass", xlab = "Dates", ylab = "Foliage Biomass", ylim = ylim)
