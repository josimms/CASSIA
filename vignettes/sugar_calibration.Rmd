...
objective_function <- function(par) {
  ...
  sperling_test_local[c("percentage_needle_storage", "percentage_phloem_storage", "percentage_xylem_sh_storage", "percentage_xylem_st_storage", "percentage_roots_storage", "myco.thresh")] <- c(0.1, 0.2, 0.06, 0.006, 0.15, 0.3)
...
parameters_2015$sperling_test[c("percentage_needle_storage", "percentage_phloem_storage", 
    "percentage_xylem_sh_storage", "percentage_xylem_st_storage", 
    "percentage_roots_storage", "myco.thresh"), "Hyde"] <- c(0.1, 0.2, 0.06, 0.006, 0.15, 0.3)
...
plot(dates, 0.1 * CASSIA_preles_1998_2022_sugar_low$Culm_Growth$culm_growth_diameter, type = "l", col = "red", ylab = "Diameter (cm)", xlab = "Years", ylim = c(14, 22))
