...
plot_sugar_starch_comparison(CASSIA_new_output_sugar, weather_original$dates, loaded_data$original_data, loaded_data$yu_data)
```
...
```{r}
plot_sugar_starch_comparison(CASSIA_preles_1998_2022_sugar_mine, weather_preles_1998_2022$dates, loaded_data$original_data, loaded_data$yu_data)
```
