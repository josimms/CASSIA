...
Rcpp::List CASSIA_yearly(int start_year,
  ...
  all_out.culm_growth.diameter[0] = 1000 * parameters.D0;
  all_out.culm_growth.diameter_potential[0] = 1000 * parameters.D0;
  ...
  // TODO: units
  all_out.culm_growth.xylem_sh[0] = 0.8 * M_PI * pow(parameters.D0/2.0, 2.0) * parameters.h0 * parameters.cell_wall_density_ew; // 80% of the diameter is sapwood
  all_out.culm_growth.phloem[0] = M_PI * pow(1.5, 2.0) * parameters.h0 * parameters.cell_wall_density_ew;
