...
# TODO: is the updated height used anywhere?
# TODO: what time of year are the measurements taken?
ylim = range(141.6 - 0.1416 + CASSIA_preles_1998_2022$Culm_Growth$culm_growth_diameter, 10 *diameter_df$amount)
plot(date_1998_2022, 141.6 - 0.1416 + CASSIA_preles_1998_2022$Culm_Growth$culm_growth_diameter, col = "black", pch = "x", main = "Diameter", xlab = "Dates", ylab = "Diameter", ylim = ylim)
points(as.Date(paste0(diameter_df$date, "-12-31")), 10 * diameter_df$amount, col = "green", pch = as.numeric(as.factor(diameter_df$variable))+16)
legend("topleft", legend = unique(as.factor(diameter_df$variable)), pch = unique(as.numeric(as.factor(diameter_df$variable))+16), bty = "n", ncol = 1, title = "Measurement Desciption", col = "green", cex = 0.75)

ylim = range(CASSIA_preles_1998_2022$Culm_Growth$culm_growth_roots)
plot(date_1998_2022, CASSIA_preles_1998_2022$Culm_Growth$culm_growth_roots, col = "black", pch = "x", main = "Roots", xlab = "Dates", ylab = "Roots", ylim = ylim)
# TODO: data
...
ylim = range(CASSIA_preles_1998_2022$Culm_Growth$culm_growth_needles, foliage_biomass_df$amount, cumsum(CASSIA_preles_1998_2022$Growth$needle_growth))
plot(date_1998_2022, CASSIA_preles_1998_2022$Culm_Growth$culm_growth_needles, col = "black", pch = "x", main = "Foliage Biomass", xlab = "Dates", ylab = "Foliage Biomass")
...
legend("topleft", legend = unique(as.factor(foliage_biomass_df$variable)), pch = unique(as.numeric(as.factor(foliage_biomass_df$variable))+16), bty = "n", ncol = 1, title = "Measurement Desciption", col = "green", cex = 0.75)
...
# Sugar, Starch
par(mfrow = c(1, 2))
plot(date_1998_2022, CASSIA_preles_1998_2022_sugar_high$Sugar$sugar, type = "l", col = "blue", ylab = "Sugar", xlab = "Dates")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_medium$Sugar$sugar, col = "gold")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_low$Sugar$sugar, col = "red")

plot(date_1998_2022, CASSIA_preles_1998_2022_sugar_high$Sugar$starch, type = "l", col = "blue", ylab = "Starch", xlab = "Dates")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_medium$Sugar$starch, col = "gold")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_low$Sugar$starch, col = "red")

# Storage term
par(mfrow = c(1, 1))
plot(date_1998_2022, CASSIA_preles_1998_2022_sugar_high$Sugar$storage_term, type = "l", col = "blue", ylab = "Storage term", xlab = "Dates")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_medium$Sugar$storage_term, col = "gold")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_low$Sugar$storage_term, col = "red")

# Seasonal, Storage
par(mfrow = c(1, 2))
plot(date_1998_2022, CASSIA_preles_1998_2022_sugar_high$Growth$height_growth, type = "l", col = "blue", ylab = "Height", xlab = "Dates")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_medium$Growth$height_growth, col = "gold")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_low$Growth$height_growth, col = "red")

plot(date_1998_2022, CASSIA_preles_1998_2022_sugar_high$Growth$diameter_growth, type = "l", col = "blue", ylab = "Diameter", xlab = "Dates")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_medium$Growth$diameter_growth, col = "gold")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_low$Growth$diameter_growth, col = "red")

# Culmative
plot(date_1998_2022, CASSIA_preles_1998_2022_sugar_high$Culm_Growth$culm_growth_height, type = "l", col = "blue", ylab = "Height", xlab = "Dates")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_medium$Culm_Growth$culm_growth_height, col = "gold")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_low$Culm_Growth$culm_growth_height, col = "red")

plot(date_1998_2022, CASSIA_preles_1998_2022_sugar_high$Culm_Growth$culm_growth_diameter, type = "l", col = "blue", ylab = "Diameter", xlab = "Dates")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_medium$Culm_Growth$culm_growth_diameter, col = "gold")
lines(date_1998_2022, CASSIA_preles_1998_2022_sugar_low$Culm_Growth$culm_growth_diameter, col = "red")

legend("topleft", c("High", "Medium", "Low"), col = c("blue", "gold", "red"), lty = 1, bty = "n")
```
