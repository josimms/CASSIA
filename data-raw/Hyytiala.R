load(paste0("/home/joanna/Asiakirjat/Hyytiälä/", "Hyde_weather_CASSIA.RData"))

FMI_Data <- lapply(paste0("/home/joanna/Asiakirjat/Hyytiälä/", list.files(path = "/home/joanna/Asiakirjat/Hyytiälä/", pattern = "CASSIA-csv-"))[c(11:12, c(9, 5), c(6, 1), c(13, 10), c(7, 3), c(2, 8), c(14, 4))], read.csv, na.string  = "-")
