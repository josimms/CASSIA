...
legend("topright", c("Needles", "Phloem", "Xylem Sh", "Xylem St", "Roots"), col = c("green", "brown", "red", "gold", "black"), lty = 1)
...
par(mfrow = c(1, 2))
plot(dates, CASSIA_preles_1998_2022_roots_surplus_c$Sugar$nitrogen_capacity, type = "l", xlab = "Years", ylab = "Nitorgen Capacity (between 0 and 1)", col = "red", ylim = c(0, 1))
...
abline(h = mean(CASSIA_preles_1998_2022$Sugar$starch), lty = 2, col = "green")
#abline(h = mean(CASSIA_preles_1998_2022_nitrogen_medium$Sugar$starch), lty = 2, col = "red")
...
par(mfrow = c(1, 2))
plot(dates, CASSIA_preles_1998_2022_nitrogen_low$Sugar$nitrogen_capacity, type = "l", xlab = "Years", ylab = "Nitorgen Capacity (between 0 and 1)", col = "red", ylim = c(0, 1))
...
#lines(dates, CASSIA_preles_1998_2022_nitrogen_medium$Sugar$nitrogen_capacity, col = "red")
