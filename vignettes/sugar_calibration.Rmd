...
parameters_2015$sperling_test[names(fit$optim$bestmem), "Hyde"] <- c(
  # Ezymes
  0.01, 0.0, 0.01,   # needles
  0.01, 0.0, 0.01,   # phloem
  0.01, 0.0, 0.01,   # roots
  0.01, 0.0, 0.01,   # xylem.sh
  0.01, 0.0, 0.01,   # xylem.st
  0.07, 0.11, 0.2, 0.01, 0.1,
...
plot(dates, CASSIA_preles_1998_2022$Sugar$sugar_to_mycorrhiza, main = "Surgar Out Seperated by Type", col = "red", 
     xlab = "Date", ylab = "Sugar, Kg C", type = "l", ylim = range(c(CASSIA_preles_1998_2022$Sugar$sugar_to_mycorrhiza, CASSIA_preles_1998_2022$Sugar$sugar_out_surplus)))
lines(dates, CASSIA_preles_1998_2022$Sugar$sugar_out_surplus)

CASSIA_preles_1998_2022$Culm_Growth$culm_growth_diameter
