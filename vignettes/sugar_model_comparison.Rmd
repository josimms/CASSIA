...
parameters_1998_2022$sperling_test[c("Ad0.needles", "Ad0.phloem", "Ad0.roots", "Ad0.xylem.sh", "Ad0.xylem.st"),c("Hyde")] <- c()
parameters_1998_2022$sperling_test[c("lamda.needles", "lamda.phloem", "lamda.roots", "lamda.xylem.sh", "lamda.xylem.st"),c("Hyde")] <- c()
parameters_1998_2022$sperling_test[c("delta.needles", "delta.phloem", "delta.roots", "delta.xylem.sh", "delta.xylem.st"),c("Hyde")] <- c()
parameters_1998_2022$sperling_test[c("k_np", "k_pr", "k_pxsh", "k_pxst", "myco.thresh"),c("Hyde")] <- c()
```
